...
class CreateGradasiKasarsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gradasi_kasars', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('ukuran_butir')->nullable();
            ...
            $table->double('inputa_7')->nullable();
            $table->double('inputa_8')->nullable();
            $table->double('inputa_9')->nullable();
            ...
            $table->double('berat_tinggal_inputa_7')->nullable();
            $table->double('berat_tinggal_inputa_8')->nullable();
            $table->double('berat_tinggal_inputa_9')->nullable();
            ...
            $table->double('berat_kumu_inputa_7')->nullable();
            $table->double('berat_kumu_inputa_8')->nullable();
            $table->double('berat_kumu_inputa_9')->nullable();
            ...
            $table->double('berat_kumu_la_7')->nullable();
            $table->double('berat_kumu_la_8')->nullable();
            $table->double('berat_kumu_la_9')->nullable();
            $table->double('sisa_berat_kumu_la')->nullable();
            $table->double('jumlah_berat_kumu_la')->nullable();
            $table->double('modulus_halus')->nullable();
            $table->enum('kerikil_daerah',['10 mm','20 mm','40 mm']);
    ...
    {
        Schema::dropIfExists('gradasi_kasars');
    }
}
