...
class DashboardController extends Controller
{
    public function index()
    {
        if (Auth::user()->role == 'Admin') {
            ...
            $ssd_halus = PengujianSsdAgregateHalus::where('user_id', Auth::user()->id )->where('status_verifikasi','1')->get();
            ...
            $ssd_halus_new = PengujianSsdAgregateHalus::where('user_id', Auth::user()->id )->where('status_verifikasi','0')->get();
