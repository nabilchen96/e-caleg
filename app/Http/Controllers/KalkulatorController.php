...
class KalkulatorController extends Controller
{
    public function index(){
        ...
        return view('kalkulator', [
            'nilai_lari'        => $nilai_lari->nilai ?? ($nilai_lari ?? 0), 
            'nilai_pushup'      => $nilai_pushup->nilai ?? ($nilai_pushup ?? 0), 
            'nilai_situp'       => $nilai_situp->nilai ?? ($nilai_situp ?? 0), 
            'nilai_shuttlerun'  => $nilai_shuttlerun->nilai ?? ($nilai_shuttlerun ?? 0)
        ]);
    }
}
