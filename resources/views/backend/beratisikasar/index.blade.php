        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-12 col-xl-8 mb-xl-0">
                    <h3 class="font-weight-bold text-white">Data Pengujian Berat Satuan Agregat Kasar</h3>
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="keadaan_kerikil" class="form-control" id="keadaan_kerikil">
                        ...
                        <div class="form-group">
                            ...
                            <input name="b2" id="b2" type="text" placeholder="Berat Kerikil + Bejana"
