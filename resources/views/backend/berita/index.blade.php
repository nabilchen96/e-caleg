            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header p-3">
                        <h5 class="modal-title m-2" id="exampleModalLabel">Berita form</h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" class="form-control" id="kategori">
                                ...
                                <option>Tips dan Trick</option>
                                <option>Project</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Gambar  <span class="text-danger" style="font-size: 12px;">(Max size: 500kb)</span></label>
...
@push('script')
    <script>
        ...
        form.onsubmit = (e) => {
            ...
            axios({
                    method: 'post',
                    url: formData.get('id') == '' ? '/back/store-berita' : '/back/update-berita',
                    data: formData,
                })
                .then(function(res) {
                    //handle success         
