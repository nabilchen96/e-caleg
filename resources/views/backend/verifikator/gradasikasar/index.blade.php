...
@push('script')
    <script>
        ...
        form.onsubmit = (e) => {
            ...
            axios({
                    method: 'post',
                    url: formData.get('id') == '' ? '/store-gradasi-kasar' : '/verifikasi-gradasi-kasar',
                    data: formData,
                })
                .then(function(res) {
                    //handle success         
