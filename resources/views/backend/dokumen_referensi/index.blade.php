        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-12 col-xl-8 mb-xl-0">
                    <h3 class="font-weight-bold text-white">Data Dokumen Referensi</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header p-3">
                        <h5 class="modal-title m-2" id="exampleModalLabel">Dokumen Referensi Form</h5>
                    </div>
    ...
    <script>
        ...
        function getData() {
            $("#myTable").DataTable({
                ...
                columns: [{
                    ...
                    {
                        render: function(data, type, row, meta) {
                            return `<a href=${row.link_file} target="_blank">
                                   ${row.judul}
                                </a>`
                        }
                    },
        ...
        $('#modal').on('show.bs.modal', function(event) {
            ...
            if (recipient) {
                ...
                modal.find('#link_file').val(cokData[0].link_file)
                modal.find('#status_publish').val(cokData[0].status_publish)
            }
        })
            ...
            axios({
                ...
                .then(function(res) {
                    ...
                    if (res.data.responCode == 1) {
                        ...
                        document.getElementById('judul_alert').innerHTML = res.data.respon.judul ?? ''
                    }
