...
@section('content')
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-12 col-xl-8 mb-xl-0">
                    <h3 class="font-weight-bold">Data TPS</h3>
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_tps" id="kode_tps" class="form-control" required
                                placeholder="Kode TPS">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama TPS <sup class="text-danger">*</sup></label>
                            <input type="text" name="nama_tps" id="nama_tps" class="form-control" required
                                placeholder="Nama TPS">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Kelurahan / Desa <sup class="text-danger">*</sup></label>
                            <?php
                            $desa = DB::table('kelurahans')->get();
                            ?>
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Max Surat Suara<sup class="text-danger">*</sup></label>
                            <input type="number" name="max_surat_suara" id="max_surat_suara" class="form-control" required
    ...
    <div class="modal fade" id="import" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="formimport" action="{{ url('import-tps') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="modal-header p-3">
                        ...
                        <div class="form-group">
                            ...
                            <ul class="mt-4">
                                <li>Download contoh Format untuk Import File Excel <a
                                        href="{{ asset('file_import') }}/TPS Import.xlsx">[ Download ]</a>
                                </li>
    ...
    <script>
        ...
        $('#modal').on('show.bs.modal', function(event) {
            ...
            if (recipient) {
                ...
                modal.find('#kode_tps').val(cokData[0].kode_tps)
                modal.find('#nama_tps').val(cokData[0].nama_tps)
                modal.find('#max_surat_suara').val(cokData[0].max_surat_suara)
            }
        })
        ...
        form.onsubmit = (e) => {
            ...
            axios({
                    method: 'post',
                    url: formData.get('id') == '' ? '/store-tps' : '/update-tps',
                    data: formData,
                })
                .then(function(res) {
                    //handle success         
